...
# posts_graph is a bipartite graph matching comments to posts
    ...
    f = open("LIWC_DATA/utility_graphs2/utility_graph_list.pkl", "w")
    ...
    while diff.days / 7 >= 2:
        ...
        while max_date <= end_date:
            ...
            nx.write_gexf(d, "LIWC_DATA/utility_graphs2/%d_digraph_%s_%s.gexf" % (diff.days / 7,
                                                                                 datetime.datetime.strftime(min_date, "%Y-%m-%d"), datetime.datetime.strftime(max_date, "%Y-%m-%d")))

            # f = open("LIWC_DATA/utility_graphs2/%d_posts_%s_%s.pkl" % (diff.days / 7, datetime.datetime.strftime(
